    ...
    public class DatabaseService
    {
        ...
        private static ConvenantInfoData MapConvenantInfoData(SqlDataReader reader)
        {
            return new ConvenantInfoData
            {
                ...
                BijdrageHypotheekrenteIngangsdatum = SafeReadDateTime(reader, "bijdrage_hypotheekrente_ingangsdatum"),
            ...
            try
            {
                ...
                while (await reader.ReadAsync())
                {
                    artikelen.Add(new ArtikelData
                    {
                        ...
                        ConditieConfigJson = reader["conditie_config"] == DBNull.Value ? null : ConvertToString(reader["conditie_config"]),
